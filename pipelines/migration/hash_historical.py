...
retrieves historical NIH grant records that do not have a content hash, 
generates a SHA-256 hash based on the title, abstract, phr, and total award amount, and 
updates the record with the generated hash. 
