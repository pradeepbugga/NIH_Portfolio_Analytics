...
def test_normalize_project_num():
    ...
    assert normalize_project_num("1R01CA123456-01") == "R01CA123456"


def test_normalize_project_num_normalized():

    assert normalize_project_num("NR01CA123456-01") == "NR01CA123456"
...
def test_normalize_name_last_first():
    ...
    first, middle, last, canonical = normalize_name("Smith, John A")
...
def test_normalize_name_first_middle_last():
    ...
    first, middle, last, canonical = normalize_name("John A Smith")
...
def test_normalize_name_two_part():
    ...
    first, middle, last, canonical = normalize_name("John Smith")
...
def test_normalize_name_multiword_middle():
    ...
    first, middle, last, canonical = normalize_name("John Adam Brian Smith")
