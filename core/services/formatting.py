...
def extract_funding(results: dict) -> tuple[list[int], list[float]]:
    ...
    print(
        f"Current fiscal year: {current_fy}, months elapsed: {months_elapsed}, scaling factor: {scaling_factor}"
    )
...
def format_output_grants(ranked_docs: list[dict]) -> list[dict]:
    ...
    for g in ranked_docs:
        ...
        first, middle, last = (
            g.get("pi_first_name") or "",
            g.get("pi_middle_name") or "",
            g.get("pi_last_name") or "",
        )
